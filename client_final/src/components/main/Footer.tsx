    ...
    <div>
      <div className="mt-20 py-8 bg-gradient-to-r from-[#040b14] to-[#031a2f] text-white">
        <div className="w-[80%] mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          {/* Logo */}
          <div className="w-16">
            <img src={images.logo} alt="Logo" className="w-full invert" />
          </div>

          {/* Copyright */}
          <div className="text-center">
            <p className="text-gray-300">© 2024 Government Polytechnic Nagpur</p>
            <p className="text-gray-400 text-sm mt-2">Department of Computer Engineering</p>
